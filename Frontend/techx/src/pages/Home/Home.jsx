...
function Home() {
  ...
  const sendEmail = (e) => {
    alert("Message has been added. We will contact you.Thank YOU.");
    ...
    <div className='flex flex-col max-w-screen-xl mx-auto '>
      ...
      <div className='flex flex-col sm:w-[80vh] w-[40vh] gap-4 mx-auto mb-7 mt-7'>
        <div className='relative flex flex-col items-center mb-8'>
          ...
          <p className='absolute text-xs text-white sm:text-sm top-6 sm:top-8'>How can we help you today?</p>
        </div>

        <form className='flex flex-col gap-3' ref={contactRef} onSubmit={sendEmail}>
          <div className='flex flex-col justify-between gap-4 sm:flex-row sm:gap-3'>
          ...
          <button type='submit' className='bg-[#25AEFF] rounded-md text-xs font-semibold text-center px-3 py-2 hover:bg-[#3e7596] cursor-pointer ' id = '88'>SUBMIT</button>
        </form>
      </div>
    </div>
  );
